            ...
            <CollapsibleItem header="Student Details" icon='add'>
              <form>
                <Row>
                  ...
                  <Row>
                    <Input name="family" type="checkbox" value="Mom" label="Mom" onChange={this.handleInputChange} value={this.state.family.mom}/>
                    <Input name="family" type="checkbox" value="Mom" label="Dad" onChange={this.handleInputChange} value={this.state.family.dad}/>
                    <Input name="family" type="checkbox" value="Mom" label="Sister" onChange={this.handleInputChange} value={this.state.family.sister}/>
                    <Input name="family" type="checkbox" value="Mom" label="Brother" onChange={this.handleInputChange} value={this.state.family.brother}/>
                  </Row>
